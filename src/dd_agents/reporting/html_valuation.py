...
class ValuationBridgeRenderer(SectionRenderer):
    ...
    def render(self) -> str:
        ...
        parts.append(
            "<table class='subject-table sortable'><caption>Valuation impact at multiples</caption><thead><tr>"
        ...
        if categories:
            ...
            parts.append(
                "<table class='subject-table sortable'><caption>Risk category breakdown</caption><thead><tr>"
