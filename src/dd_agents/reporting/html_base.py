...
def render_nav_bar(section_rag: dict[str, str] | None = None) -> str:
    ...
    return (
        ...
        "<a href='#sec-discount'>Discount &amp; Pricing</a>"
        "<a href='#sec-renewal'>Renewal Analysis</a>"
        "<a href='#sec-compliance'>Compliance Risk</a>"
        "<a href='#sec-entity'>Entity Distribution</a>"
        "<a href='#sec-timeline'>Contract Timeline</a>"
        "</div>"
        # Portfolio
        "<div class='toc-group'>"
